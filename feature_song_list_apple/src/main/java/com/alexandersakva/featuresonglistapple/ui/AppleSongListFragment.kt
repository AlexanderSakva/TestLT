...
import kotlinx.android.synthetic.main.apple_song_list_fragment.*
import javax.inject.Inject


open class AppleSongListFragment : Fragment(), HasTitle {

    @Inject
    lateinit var viewModelFactory: ViewModelProvider.Factory

    private val viewModel by viewModels<AppleSongListViewModel>({ this }, { viewModelFactory })
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.apple_song_list_fragment, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.songs.observe(viewLifecycleOwner, Observer {
            adapter.items = it
            if (it.isEmpty()) showToast(getString(R.string.apple_songs_not_found))
        })
        ...
        viewModel.isFetchSuccessful.observe(viewLifecycleOwner, Observer {
            if (!it) {
                showToast(getString(R.string.apple_songs_error))
            }
        })
    }
